...
def main(args):
    ...
    easy_order = [16, 14, 0, 15, 8, 13, 11, 12, 1, 7, 3, 17, 4, 5, 6, 2, 18, 19, 9, 10]
    easy_order.reverse()
    # Choose any task order - ref {yoon et al. ICLR 2020}
    task_order = [np.array(easy_order),
                  np.array([16, 14, 0, 15, 8, 13, 11, 12, 1, 7, 3, 17, 4, 5, 6, 2, 18, 19, 9, 10]), #50 epochs
                  np.array([14, 16, 15, 0, 13, 8, 12, 1, 11, 3, 5, 18, 17, 6, 4, 7, 2, 19, 10, 9]), #20 epochs
    ...
    for k,ncla in taskcla:
        ...
        for jj in range(n_tasks):
            ...
            xtest = data[task_no]['test']['x']
            ytest = data[task_no]['test']['y']
