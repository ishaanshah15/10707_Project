...
def main(args):
    ...
    for k, ncla in taskcla:
        ...
        for epoch in range(1, args.n_epochs+1):
            ...
            if epoch%100 == 0:
                save_name = "csnb_cifar100_1_{}_{}_SEED_{}_LR_{}_SPARSITY_{}".format(args.model,args.encoding, args.seed, args.lr, 1 - args.sparsity)
                save_name += '_epoch_{}'.format(epoch)
                print(save_name)
                torch.save(model, "./results2/csnb_cifar100_10/" + save_name + ".ptmodel")
